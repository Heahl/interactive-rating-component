            ...
            <div>
              ...
              >
                {[1, 2, 3, 4, 5].map((value) => (
                  <button
                    type="button"
                    className={`text-light-grey h-16 w-16 flex-row items-center justify-center rounded-full text-2xl font-medium hover:bg-orange-500 ${value <= hoverRating ? "bg-orange text-black" : isRated && value <= rating ? "bg-white text-black" : "bg-gray-700/50"}`}
                    key={value}
